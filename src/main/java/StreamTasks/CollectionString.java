...
a. Отсортировать коллекцию строк по алфавиту
b. Добавить "_1" к каждому элементу
c. В коллекции убрать первый символ и вернуть массив чисел (int[])
d. Отсортировать коллекцию строк по алфавиту и убрать дубликаты */
